...
- Name: return-order-test.spec.ts >> 退货订单功能 E2E 测试 - 生产环境 >> 测试6: 关闭抽屉正常工作
- Location: tests/return-order-test.spec.ts:219:7
      ...
      - main [ref=e93]:
        - generic [ref=e96]:
          - generic [ref=e98]:
            ...
            - button "plus Return Order" [active] [ref=e105] [cursor=pointer]:
              - img "plus" [ref=e107]:
                - img [ref=e108]
